...
public class HistoryFrame extends JFrame implements ActionListener/*, Printable*/ {
	...
	public HistoryFrame(ArrayList<OrderDetail> orderDetailList) {

		OrderControlUtility.setIconImage(this);

		setTitle("【注文履歴】 KIDDA-LA 業務システム");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == btnReturnSearch) {
